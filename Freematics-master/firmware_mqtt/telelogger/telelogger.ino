...
#include "teleclient_mqtt.h"  // <-- MQTT client (ใหม่)
#if BOARD_HAS_PSRAM
...
PID_POLLING_INFO obdData[] = {
    ...
    // {PID_SHORT_TERM_FUEL_TRIM_2, 1},
    // {PID_LONG_TERM_FUEL_TRIM_2, 1},
    // {PID_FUEL_PRESSURE, 1},
    // {PID_INTAKE_MAP, 1},
    {PID_RPM, 1},
    {PID_SPEED, 1},
    ...
    // {PID_AUX_INPUT, 1},
    {PID_RUNTIME, 1},
    {PID_DISTANCE_WITH_MIL, 1},
    // {PID_COMMANDED_EGR, 1},
    // {PID_EGR_ERROR, 1},
    // {PID_COMMANDED_EVAPORATIVE_PURGE, 1},
    // {PID_FUEL_LEVEL, 1},
    // {PID_WARMS_UPS, 1},
    // {PID_DISTANCE, 1},
    // {PID_EVAP_SYS_VAPOR_PRESSURE, 1},
    {PID_BAROMETRIC, 1},
    ...
    // {PID_ABSOLUTE_THROTTLE_POS_C, 1},
    // {PID_ACC_PEDAL_POS_D, 1},
    // {PID_ACC_PEDAL_POS_E, 1},
    // {PID_ACC_PEDAL_POS_F, 1},
    // {PID_COMMANDED_THROTTLE_ACTUATOR, 1},
    // {PID_TIME_WITH_MIL, 1},
    // {PID_TIME_SINCE_CODES_CLEARED, 1},
    // {PID_ETHANOL_FUEL, 1},
    // {PID_FUEL_RAIL_PRESSURE, 1},
    // {PID_HYBRID_BATTERY_PERCENTAGE, 1},
    // {PID_ENGINE_OIL_TEMP, 1},
    // {PID_FUEL_INJECTION_TIMING, 1},
    {PID_ENGINE_FUEL_RATE, 1},
    // {PID_ENGINE_TORQUE_DEMANDED, 1},
    // {PID_ENGINE_TORQUE_PERCENTAGE, 1},
    // {PID_ENGINE_REF_TORQUE, 1},
    // {PID_ODOMETER, 1},
    //เพิ่มจาก WIKI OBD-II PIDs
    {PID_ENGINE_COOLANT_TEMP_2, 1},
    // {PID_SECONDARY_AIR_STATUS, 1},
    // {PID_O2_SENSORS_PRESENT, 1},
    // {PID_O2_B1S1, 1},
    // {PID_O2_B1S2, 1},
    // {PID_O2_B1S3, 1},
    // {PID_O2_B1S4, 1},
    ...
    // {PID_O2_B2S4, 1},
    // {PID_OBD_STANDARDS, 1},
    // {PID_O2_SENSORS_PRESENT_B, 1},
    // {PID_FUEL_RAIL_GAUGE_PRESS, 1},
    // {PID_FUEL_RAIL_ABS_PRESS, 1},
    // {PID_O2WR_B1S1_LAMBDA, 1},
    // {PID_O2WR_B1S2_LAMBDA, 1},
    // {PID_O2WR_B1S3_LAMBDA, 1},
    // {PID_O2WR_B1S4_LAMBDA, 1},
    // {PID_O2WR_B2S1_LAMBDA, 1},
    // {PID_O2WR_B2S2_LAMBDA, 1},
    // {PID_O2WR_B2S3_LAMBDA, 1},
    // {PID_O2WR_B2S4_LAMBDA, 1},
    // {PID_O2WR_B1S1_CURRENT, 1},
    // {PID_O2WR_B1S2_CURRENT, 1},
    // {PID_O2WR_B1S3_CURRENT, 1},
    // {PID_O2WR_B1S4_CURRENT, 1},
    // {PID_O2WR_B2S1_CURRENT, 1},
    // {PID_O2WR_B2S2_CURRENT, 1},
    // {PID_O2WR_B2S3_CURRENT, 1},
    // {PID_O2WR_B2S4_CURRENT, 1},
    // {PID_MONITOR_STATUS_DRIVE, 1},
    // {PID_MAX_VALUES, 1},
    // {PID_MAX_MAF, 1},
    // {PID_FUEL_TYPE, 1},
    // {PID_ABS_EVAP_PRESS, 1},
    // {PID_EVAP_PRESS_2, 1},
    // {PID_ST_O2_TRIM_B1B3, 1},
    // {PID_LT_O2_TRIM_B1B3, 1},
    // {PID_ST_O2_TRIM_B2B4, 1},
    // {PID_LT_O2_TRIM_B2B4, 1},
    {PID_REL_ACCEL_PEDAL, 1},
    // {PID_EMISSION_REQ, 1},
    // {PID_ENGINE_PCT_TORQUE, 1},
    // {PID_AUX_IO_SUPPORT, 1},
    // {PID_MAF_SENSOR, 1},

    {PID_INTAKE_AIR_TEMP_B, 1},
    // {PID_CMD_EGR_EGR_ERR, 1},
    // {PID_CMD_DIESEL_INTAKE, 1},
    // {PID_EGR_TEMP, 1},
    // {PID_CMD_THROTTLE_CTRL, 1},
    // {PID_FUEL_PRESS_CTRL, 1},
    // {PID_INJECT_PRESS_CTRL, 1},
    // {PID_TURBO_COMPRESSOR_PRES, 1},
    {PID_BOOST_PRESS_CTRL, 1},
    // {PID_VGT_CTRL, 1},
    // {PID_WASTEGATE_CTRL, 1},
    // {PID_EXHAUST_PRESS, 1},
    // {PID_TURBO_RPM, 1},
    // {PID_TURBO_TEMP_A, 1},
    // {PID_TURBO_TEMP_B, 1},
    // {PID_INTERCOOLER_TEMP, 1},
    // {PID_EGT_SENSOR_B1, 1},
    // {PID_EGT_SENSOR_B2, 1},
    // {PID_DPF_DIFF_PRESS, 1},
    // {PID_DPF_TEMP, 1},
    // {PID_DPF_TEMP_2, 1},
    // {PID_NOX_NTE_CTRL, 1},
    // {PID_PM_NTE_CTRL, 1},
    // {PID_ENGINE_RUN_TIME, 1},
    // {PID_ENGINE_RUN_PERF, 1},
    // {PID_ENGINE_RUN_PERF_DIESEL, 1},
    // {PID_NOX_SENSOR, 1},
    // {PID_MANIFOLD_SURF_TEMP, 1},
    // {PID_NOX_REAGENT_SYS, 1},
    // {PID_PM_SENSOR, 1},
    // {PID_INTAKE_MAP_B, 1},
    // {PID_SCR_INDUCEMENT, 1},
    // {PID_RUN_PERF_2, 1},
    // {PID_RUN_PERF_DIESEL_2, 1},
    // {PID_FUEL_SYS_CTRL, 1},
    // {PID_WWHOBD_DEMAND_TORQUE, 1},
    // {PID_EXHAUST_TORQUE_DEMAND, 1},
    // {PID_ENGINE_FRICTION_TORQUE, 1},
    // {PID_PM_AFTERTREAT_FUEL, 1},
};
...
// ใช้ MQTT แทน HTTP/UDP
TeleClientMQTT teleClient;
...
void initialize()
{
  ...
  if (!state.check(STATE_OBD_READY)) {
    ...
    if (obd.init()) {
      ...
      char buffer[128];
      if (obd.sendCommand("ATDPN\r", buffer, sizeof(buffer), 2000))
      {
        String protoStr = String(buffer);
        protoStr.trim(); // ตัดช่องว่างหรือ \r\n ออก
        detectedProtocol = protoStr;
        Serial.print("Detected Protocol: ");

        if (protoStr == "A6")
        {
          Serial.println("ISO 15765-4 (CAN 11/500)");
        }
        else if (protoStr == "A7")
        {
          Serial.println("ISO 15765-4 (CAN 29/500)");
        }
        else if (protoStr == "A8")
        {
          Serial.println("ISO 15765-4 (CAN 11/250)");
        }
        else if (protoStr == "A9")
        {
          Serial.println("ISO 15765-4 (CAN 29/250)");
        }
        else if (protoStr == "A3")
        {
        ...
        {
          Serial.println("ISO 14230-4 (KWP 5BAUD)");
        }
        else if (protoStr == "A5")
        {
          Serial.println("ISO 14230-4 (KWP FAST)");
        }
        else
        {
          Serial.println("Unknown or Other Protocol");
        }
      }
      else
      {
        Serial.println("RPM Read Failed (Engine might be OFF)");
      }
...
void process()
{
  ...
  uint8_t pVal = (uint8_t)strtol(detectedProtocol.c_str(), NULL, 16);
  buffer->add(0xFF, ELEMENT_UINT8, &pVal, 1);
...
void telemetry(void* inst)
{
  ...
  for (;;) {
    ...
    while (state.check(STATE_WORKING)) {
      ...
      store.header(devid); // MQTT: ใส่ header เสมอเพื่อ identify device
